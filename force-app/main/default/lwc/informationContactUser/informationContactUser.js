...
export default class InformationContactUser extends LightningElement {
    @api typeUtilisateur //  importer le typeuser saisie dans le premier composant
    ...
    handleProduitChange(event) {
     ...
     connectedCallback() {
        // Afficher le champ Produit uniquement si le type d'utilisateur est "Animateur"
        this.afficherProduit = this.typeUtilisateur === 'Animateur';
    }
